...
class Message(ApiHandler):
    ...
    async def communicate(self, input: dict, request: Request):
        ...
        if request.content_type.startswith("multipart/form-data"):
            ...
            # Use consistent paths that actually exist
            upload_folder_int = files.get_abs_path("tmp/uploads")  # Internal path for file references
            upload_folder_ext = files.get_abs_path("tmp/uploads")  # External save path
