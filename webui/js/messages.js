...
import { convertMultimediaTags, renderMultimediaContent, enhanceImageRendering } from "./enhanced-multimedia-renderer.js";
...
export function _drawMessage(
  ...
  if (content && content.trim().length > 0) {
    if (markdown) {
      ...
      processedContent = convertMultimediaTags(processedContent);
      ...
      // Enhance multimedia elements
      const images = contentDiv.querySelectorAll('img.multimedia-image');
